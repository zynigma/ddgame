...
namespace TextFx
{
	...
	public class LetterAction
	{
		...
		public ActionColorProgression m_start_colour = new ActionColorProgression(new VertexColour(Color.white));
		public ActionColorProgression m_end_colour = new ActionColorProgression(new VertexColour(Color.white));
