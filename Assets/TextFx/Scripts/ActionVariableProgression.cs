...
//		public override int[] ProgressionExtraOptionIndexes { get { return EXTRA_OPTION_INDEXS; } }
		...
		public TextFxBezierCurve BezierCurve { get { return /*m_value_state == PROGRESSION_VALUE_STATE.REFERENCE ? ((ActionPositionVector3Progression) m_offset_progression.GetPositionVector3Prog()).m_bezier_curve : m_bezier_curve*/ null; } }
...
//				CalculateProgressions(num_progressions, curve_override == null ? offset_prog : null /*m_values, curve_override != null*/);
	...
	public class ActionColorProgression : ActionVariableProgression
	{
		...
		public VertexColour GetValue(List<LetterAction> all_letter_actions, int progression_idx, ActionColorProgression defaultAnimColourProg) 
		{
			...
			{
				ActionColorProgression prog = m_offset_progression.GetColourProg(all_letter_actions, defaultAnimColourProg);
				
				if(prog == null || prog.m_reference_data.m_action_index == m_reference_data.m_action_index && prog.m_reference_data.m_start_state == m_reference_data.m_start_state)
				{
					// Referencing itself. Not good. Infinite Loop.
				...
				{
					colValue = prog.GetValue(all_letter_actions, progression_idx, defaultAnimColourProg);
